...
var _user$project$Main$mkTh = function (label) {
	return A2(
...
var _user$project$Main$mkRowCheckbox = F3(
	function (label, state, msg) {
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Main$mkTh(label),
				_1: {
					ctor: '::',
					_0: A2(
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$checked(state),
											_1: {
												ctor: '::',
...
var _user$project$Main$mkRowTextEntry = F3(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								_elm_lang$html$Html$input,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$defaultValue(defValue),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('form-control'),
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$size(60),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _user$project$Main$mkRowSelect = F4(
				...
				_elm_lang$html$Html$option,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$selected(
							_elm_lang$core$Native_Utils.eq(val, curOpt)),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								A2(_elm_lang$core$List$map, mkOption, optList)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$paneEnv = function (model) {
	return A2(
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'UpdateInvestigationType':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{investigationType: _p0._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{submittedToInsdc: !model.submittedToInsdc}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$initialModel = {tabState: _rundis$elm_bootstrap$Bootstrap_Tab$initialState, projectName: 'Unnamed Project', investigationType: 'Unknown', submittedToInsdc: false, latitude: _elm_lang$core$Maybe$Nothing, longitude: _elm_lang$core$Maybe$Nothing};
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {tabState: a, projectName: b, investigationType: c, submittedToInsdc: d, latitude: e, longitude: f};
	});
var _user$project$Main$TabMsg = function (a) {
	return {ctor: 'TabMsg', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return A2(_rundis$elm_bootstrap$Bootstrap_Tab$subscriptions, model.tabState, _user$project$Main$TabMsg);
};
var _user$project$Main$ToggleSubmittedToInsdc = {ctor: 'ToggleSubmittedToInsdc'};
var _user$project$Main$UpdateProjectName = function (a) {
	return {ctor: 'UpdateProjectName', _0: a};
};
var _user$project$Main$UpdateInvestigationType = function (a) {
	return {ctor: 'UpdateInvestigationType', _0: a};
};
var _user$project$Main$radioInvestigationType = function (currentType) {
	var types = {
		ctor: '::',
		_0: 'Eukaryote',
		_1: {
	...
	return A4(_user$project$Main$mkRowSelect, 'Investigation Type', types, currentType, _user$project$Main$UpdateInvestigationType);
};
var _user$project$Main$paneInvestigation = function (model) {
	return A2(
		_elm_lang$html$Html$table,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A3(_user$project$Main$mkRowTextEntry, 'Project Name', model.projectName, _user$project$Main$UpdateProjectName),
			_1: {
				ctor: '::',
				_0: _user$project$Main$radioInvestigationType(model.investigationType),
				_1: {
					ctor: '::',
					_0: A3(_user$project$Main$mkRowCheckbox, 'Submitted to INSDC', model.submittedToInsdc, _user$project$Main$ToggleSubmittedToInsdc),
					_1: {ctor: '[]'}
				}
			}
		});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('MIxS UX'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					A2(
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Tab$item(
								{
									...
									link: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Investigation'),
											_1: {ctor: '[]'}
										}),
									pane: A2(
										...
										{ctor: '[]'},
										{
											...
											_1: {
												ctor: '::',
												_0: _user$project$Main$paneInvestigation(model),
												_1: {ctor: '[]'}
											}
										})
								}),
								...
								_0: _rundis$elm_bootstrap$Bootstrap_Tab$item(
									{
										...
										link: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Environment'),
												_1: {ctor: '[]'}
											}),
										pane: A2(
											_rundis$elm_bootstrap$Bootstrap_Tab$pane,
											{ctor: '[]'},
											{
												...
												_1: {
													ctor: '::',
													_0: _user$project$Main$paneEnv(model),
													_1: {ctor: '[]'}
												}
											})
									}),
						...
						_rundis$elm_bootstrap$Bootstrap_Tab$right(
							_rundis$elm_bootstrap$Bootstrap_Tab$withAnimation(
								_rundis$elm_bootstrap$Bootstrap_Tab$config(_user$project$Main$TabMsg))))),
				_1: {ctor: '[]'}
			}
		});
};
